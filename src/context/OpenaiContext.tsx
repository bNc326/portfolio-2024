    ...
    try {
      const res = await GPT?.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: `Szia én egy HR vagyok egy cégtől. Van egy ember akiről szeretném ha mondanál pár szót, hogy alkalmas lehet-e a tapasztalatai alapján. Kliens oldalon van tapasztalata React-tal és TypeScriptel. Van több hobbiprojektje ezenkívül dolgozott már szerveroldalon is express js-el, nodejs-el. Adatbázis téren találkozott már MongoDb-vel és MySQL valamint MsSQL el is. Szép igényes munkát ad ki a kezei közül és az összes oldala teljesen responsive. Még megemlíteném azt is, hogy websocket sem akadály neki. Igaz még releváns szakmai tapasztalata nincsen. Az lenne a kérdésem, hogy szerinted alkalmas-e erre/ezekre a munkára/munkákra vagy pozícióra: ${userMessage} Kérlek válaszolj a kérdésemre részletesen érvelve. Úgy formázd a szöveget, mint egy emailt/hivatalos dokumentumot pl: Kedves/Tisztelt HR! ... Üdvözlettel/Tisztelettel ChatGPT`,
          },
        ],
        stream: true,
      });
